...
function MultisigAccountName ({ children, className = '', defaultName, label, onClick, override, toggle, value, withSidebar }: Props): React.ReactElement<Props> {
...
export default React.memo(MultisigAccountName);
